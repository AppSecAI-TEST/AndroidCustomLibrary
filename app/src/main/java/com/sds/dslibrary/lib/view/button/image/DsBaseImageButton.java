...
public abstract class DsBaseImageButton extends AppCompatImageButton implements DsClickDetector.OnClickDetectListener {

    private final DsClickDetector mClickDetector = new DsClickDetector();

    public DsBaseImageButton(Context context) {
        super(context);
        init();
    }

    public DsBaseImageButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public DsBaseImageButton(Context context, AttributeSet attrs, int defStyleAttr) {
